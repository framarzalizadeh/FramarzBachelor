...
Die Edge Functions nehmen \gls{ac:http}-Anfragen des Frontends entgegen, führen 
...
\citep{make_google_docs} Anschließend wird das Dokument
programmgesteuert als \gls{ac:pdf} exportiert und dem Nutzer unmittelbar im
...
das \gls{ac:pdf}-Format konvertiert und als Datei bereitgestellt
\citep{google_docs_api,google_docs_pdf_automation}. Die resultierende
\gls{ac:pdf}-Rechnung wird in der aktuellen Implementierung nicht automatisch in
...
Hierzu wird die \gls{ac:pdf}-Datei über das WhatsApp-Sendemodul an den Nutzer
...
schnell auffindbar und revisionssicher verwalten zu können. Alle vom Nutzer hochgeladenen
...
bereits bestehende Ordner dupliziert werden.
...
ClientHub ist eine React~18.3.1 Single-Page-Application (Vite/TypeScript) für Desktop-Nutzung am Arbeitsplatz. Sidebar-Navigation (280px): Dashboard, Kunden, Ordnerbaum, Connections.
