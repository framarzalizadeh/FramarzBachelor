...
\subsection{Generierung und Versand der \gls{ac:pdf}-Rechnung}
...
2 \gls{ac:deno}/\gls{ac:ts} Functions schützen \glspl{ac:api} (Airtable/Google Drive).
...
Konsistente Daten mit Chatbot (gleiche Airtable-Base). [cite:14][file:1]
